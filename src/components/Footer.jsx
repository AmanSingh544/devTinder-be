        ...
        <>
            <footer className="bg-gray-200 text-gray-800 rounded p-10 text-center fixed bottom-0 w-full">
                ...
                <nav className="grid grid-flow-col gap-4 justify-center">
                    ...
                    <a className="text-sm text-gray-600 hover:text-gray-800 transition-colors">Contact</a>
                    <a className="text-sm text-gray-600 hover:text-gray-800 transition-colors">Jobs</a>
                    <a className="text-sm text-gray-600 hover:text-gray-800 transition-colors">Press kit</a>
                </nav>
